...
pub(crate) fn get_instruction(data: &InstructionData) -> (Instruction, u16) {
    ...
    match opcode {
        ...
        0x88 => (Instruction::Adc(ADC::Register(R8::B)), 1),
        0x89 => (Instruction::Adc(ADC::Register(R8::C)), 1),
        0x8a => (Instruction::Adc(ADC::Register(R8::D)), 1),
        0x8b => (Instruction::Adc(ADC::Register(R8::E)), 1),
        0x8c => (Instruction::Adc(ADC::Register(R8::H)), 1),
        0x8d => (Instruction::Adc(ADC::Register(R8::L)), 1),
        0x8e => (Instruction::Adc(ADC::HLAddress), 1),
        0x8f => (Instruction::Adc(ADC::Register(R8::A)), 1),
        0xCE => (Instruction::Adc(ADC::Constant(*param1)), 2),
